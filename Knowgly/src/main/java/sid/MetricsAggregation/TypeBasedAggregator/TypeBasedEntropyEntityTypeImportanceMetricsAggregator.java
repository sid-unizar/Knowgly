 ...
 */
public class TypeBasedEntropyEntityTypeImportanceMetricsAggregator extends TypeBasedMetricsAggregator {
    public static final String ENTROPY_ENTITY_TYPE_IMP_FOR_TYPE_SPARQL = "configuration/queries/metrics_aggregator_queries/entropyEntityTypeImportance_for_type.sparql";
    public static final String ENTROPY_ENTITY_TYPE_IMP_FOR_TYPE_SPARQL_NO_SUBGRAPH = "configuration/queries/metrics_aggregator_queries/entropyEntityTypeImportance_for_type_no_subgraph.sparql";
     ...
     */
    public TypeBasedEntropyEntityTypeImportanceMetricsAggregator(String typeURI, int kMeansClusters, int kMeansIterations) throws IOException {
     ...
     * @throws IOException If an IO error occurs when reading the configuration file
     */
    public TypeBasedEntropyEntityTypeImportanceMetricsAggregator(String typeURI,
     ...
     * @throws IOException If an IO error occurs when reading the configuration file
     */
    public TypeBasedEntropyEntityTypeImportanceMetricsAggregator(String typeURI) throws IOException {
        super(typeURI);
    }
     ...
     * @throws IOException If an IO error occurs when reading the configuration file
     */
    public TypeBasedEntropyEntityTypeImportanceMetricsAggregator() throws IOException {
        super("");
    }
     ...
     * @throws IOException If an IO error occurs when reading the configuration file
     */
    public TypeBasedEntropyEntityTypeImportanceMetricsAggregator(MetricsAggregator combinationAggregator, double combinationWeight) throws IOException {
        super("");
        this.combinationAggregator = combinationAggregator;
        this.combinationWeight = combinationWeight;
    }
    ...
    public OptionalClusterInputOrTemplate getOptionalClusterInput(SPARQLEndpoint endpoint, boolean forceReturnClusterInput) throws IOException, ExecutionException, InterruptedException {
        return super.getClusterInput(endpoint,
                ENTROPY_ENTITY_TYPE_IMP_FOR_TYPE_SPARQL,
                ENTROPY_ENTITY_TYPE_IMP_FOR_TYPE_SPARQL_NO_SUBGRAPH,
